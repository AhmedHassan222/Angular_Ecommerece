...
export const routes: Routes = [
  ...
  { path: 'allorders', loadComponent:()=>import('./components/orders/orders.component').then((c)=> c.OrdersComponent ) ,canActivate:[guestGuard],  title: 'My Orders Page' },
  { path: 'edit-profile', loadComponent:()=> import('./components/edit-profile/edit-profile.component').then((c)=>c.EditProfileComponent),canActivate:[guestGuard],  title: 'Edit Profile Page' },
  ...
  { path: 'checkout/:id', loadComponent:()=> import('./components/checkout/checkout.component').then((c)=> c.CheckoutComponent),canActivate:[guestGuard],  title: 'Checkout Page' },
